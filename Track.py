...
def track_main( frame_index, frame_dict, history_contour_dict, history_motion_dict, fish_dict, fisharea_dict, avgfish_bgr, boundary, fishid_movement):
    ...
    fish_dict, fishid_nextcnt = TrackFunction.create_fishdict( fish_dict, compare_result, contours, next_contours, frame_index, cnt_mot_cmptable)

    fisharea_dict, avgfish_area, avgfish_bgr = TrackFunction.compute_avgfish_area( fisharea_dict, frame_index, frame_dict, fish_dict, next_contours, avgfish_bgr, useoldcnt_fishids)
